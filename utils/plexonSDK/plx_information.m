...
if isPl2 == 1
    ...
    % Hacked to reflect spike chan trodality. Was prev getting dropped to 1 based on analog pass-through chans. -- TBC July 2015
    Trodalness = pl2.SpikeChannels{1}.SourceTrodality;  % pl2.MinimumTrodality;
